CREATE TABLE [Demo_PB_PO_PurchaseOrders] (
...
CREATE TABLE [Demo_PB_PO_Details] (
...
[purchaseOrders_Id] int,
prebookItemId int,
[PO_number] varchar(50) references [Demo_PB_PO_PurchaseOrders](number),
[id_PO] int
);
...
CREATE TABLE [Demo_PB_PO_BreakDowns] (
...
CREATE TABLE [Demo_PB_PO_CustomFields] (
