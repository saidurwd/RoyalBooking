CREATE TABLE [dbo].[PB_PO_duplicate_invoices](
	...
	[insert_date] [datetime] NULL CONSTRAINT [DF_PB_PO_duplicate_invoices_insert_date]  DEFAULT (getdate()),
	[status] [bit] NULL CONSTRAINT [DF_PB_PO_duplicate_invoices_status]  DEFAULT ((0)),
	[old_shipdate] [datetime] NULL,
	[new_shipdate] [datetime] NULL
) 
CREATE TABLE [PB_PO_PurchaseOrders] (
...
[purchaseOrders_Id] int,
prebookItemId int,
[PO_number] varchar(50) references [PB_PO_PurchaseOrders](number),
[id_PO] int
);
...
CREATE TABLE [PB_PO_CustomFields] (
